 ...
 */
public class PostDetectionAlgorithm {
	...
	public PostDetectionAlgorithm(ArrayList<DetectedBox> boxes, FindFourModel findFour) {
	...
	public ArrayList<ArrayList<com.gradlevv.ocr.java.DetectedBox>> horizontalNumbers() {
		ArrayList<com.gradlevv.ocr.java.DetectedBox> boxes = this.combineCloseBoxes(kDeltaRowForCombine,
				kDeltaColForCombine);
		int kNumberWordCount = 4;
		ArrayList<ArrayList<com.gradlevv.ocr.java.DetectedBox>> lines = this.findHorizontalNumbers(boxes, kNumberWordCount);
